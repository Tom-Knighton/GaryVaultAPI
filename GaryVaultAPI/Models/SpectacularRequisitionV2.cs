...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class SpectacularRequisitionV2 : IEquatable<SpectacularRequisitionV2>, IValidatableObject
    {
        ...
        public SpectacularRequisitionV2(string redirect = default(string), string institutionId = default(string), Guid agreement = default(Guid), string reference = default(string), string userLanguage = default(string), string ssn = default(string), bool accountSelection = false)
        {
